...
class Features:
    ...
    def save_to_csv(self):
        file = pd.DataFrame(self.feature_matrix,columns=['Glucose_max','Glucose_min','Glucose_variance','velocity_max','velocity_min','velocity_variance','rms_max','rms_min','rms_variance'])
        # print(file)
